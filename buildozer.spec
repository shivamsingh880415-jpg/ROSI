...
requirements = python3,kivy,gTTS,pillow,gTTS,pillow
...
#       [app]
#       title = ROSI AI Assistant # This is not a comment, it is part of the title.
#
#   Warning: Indented text is treated as a multiline string - i.e.
#       [app]
#       title = ROSI AI Assistant
#          package.name = rosiai # This is all part of the title.
#
